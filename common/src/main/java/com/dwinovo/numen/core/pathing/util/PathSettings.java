...
public final class PathSettings {
     ...
     */
    public static final double COST_HEURISTIC = 4.0;
    ...
    public static final double BLOCK_PLACEMENT_PENALTY = 5.0;
    ...
    public static final int MAX_FALL_HEIGHT_NO_WATER = 5;
    ...
    public static final boolean ALLOW_DIAGONAL_ASCEND = true;
    public static final boolean ALLOW_DIAGONAL_DESCEND = true;
